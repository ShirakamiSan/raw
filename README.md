> [!WARNING]
> You are most likely going to be banned since this is detected by Hyperion. Use an alt account while running Xeno. Use the repository to understand what's happening and how it works.
